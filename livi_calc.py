        ...
        if context == 'Basic' or (context == 'CBDM' and subcontext == '0') or (context == 'Compliance' and int(subcontext) < 3):
            ...
            if simnode.pmap:
               ...
               'fatal - no valid photon ports found\n': 'Re-export the geometry'}
                ...
                pmcmd = 'mkpmap -t 10 -e {1}.pmapmon -fo+ -bv+ -apD 0.001 {0} -apg {1}-{2}.gpm {3} {4} {5} {1}-{2}.oct'.format(pportentry, svp['viparams']['filebase'], frame, simnode.pmapgno, cpentry, amentry)
