...
flovi_p_dict = {'0': {'Outlet': {'totalPressure': {'type': 'totalPressure', 'p0': 'uniform {}'.format('x'), 'gamma': '{}'.format('y'), 'value': '{}'.format('z')},
								 'fixedValue': {'type': 'fixedValue', 'value': '{}'.format('z')}},
                      'Solid': {'zeroGradient': {'type': 'zeroGradient'}},
                      'Inlet': {'zeroGradient': {'type': 'zeroGradient'}},
                      'Sky': {'symmetry': {'type': 'symmetry'}}},
                '1': {'Inlet': {'zeroGradient': {'type': 'zeroGradient'}}, 
					  'Outlet': {'totalPressure': {'type': 'totalPressure', 'p0': 'uniform {}'.format('x'), 'gamma': '{}'.format('y'), 'value': '{}'.format('z')},
								 'fixedValue': {'type': 'fixedValue', 'value': '{}'.format('z')}}, 
					  'Solid': {'zeroGradient': {'type': 'zeroGradient'}}},
                '2': {'Inlet': {'calculated': {'type': 'calculated'}}, 
					  'Outlet': {'calculated': {'type': 'calculated'}}, 
					  'Solid': {'calculated': {'type': 'calculated'}}},
                '3': {'Inlet/outlet': {'calculated': {'type': 'calculated'}}, 
                      'Solid': {'calculated': {'type': 'calculated'}}},
                '4': {'Patch': '', 
				   	  'Wall': '', 
					  'Symmetry': ''}}
...
flovi_u_dict = {'0': {'Outlet': {'pressureInletOutletVelocity': {'type': 'pressureInletOutletVelocity', 'value': '$internalField'}},
                      ...
                      'Inlet': {'fixedValue': {'type': 'fixedValue', 'value': '{}'.format('val')}, 
					  			'atmBoundaryLayerInletVelocity': {'type': 'atmBoundaryLayerInletVelocity'}},
                      'Sky': {'symmetry': {'type': 'symmetry'}}},
                '1': {'Inlet': {'fixedValue': {'type': 'fixedValue', 'value': '{}'.format('val')}}, 
					  'Outlet': {'pressureInletOutletVelocity': {'type': 'pressureInletOutletVelocity', 'value': '$internalField'}}, 
					  'Solid': {'noSlip': {'type': 'noSlip'}}},
                '2': {'Inlet': {'fixedValue': {'type': 'fixedValue', 'value': '{}'.format('val')}}, 
					  'Outlet': {'pressureInletOutletVelocity': {'type': 'pressureInletOutletVelocity', 'value': '$internalField'}}, 
					  'Solid': {'noSlip': {'type': 'noSlip'}}},
                '3': {'Inlet/outlet': {'pressureInletOutletVelocity': {'type': 'pressureInletOutletVelocity', 'value': '$internalField'}}, 
					  'Solid': {'noSlip': {'type': 'noSlip'}}},
                '4': {'Patch': '', 
				   	  'Wall': '', 
					  'Symmetry': ''}}
...
flovi_k_dict = {'0': {'Outlet': {'inletOutlet': {'type': 'inletOutlet', 'inletValue': '$internalField', 'value': '$internalField'}},
                      ...
                      'Sky': {'symmetry': {'type': 'symmetry'}}},
                '1': {'Inlet': {'fixedValue': {'type': 'fixedValue', 'value': '$internalField'}}, 
					  'Outlet': {'inletOutlet': {'type': 'inletOutlet', 'inletValue': '$internalField', 'value': '$internalField'}}, 
					  'Solid': {'kqRWallFunction': {'type': 'kqRWallFunction', 'value': '$internalField'}}},
                '2': {'Inlet': {'turbulentIntensityKineticEnergyInlet': {'type': 'turbulentIntensityKineticEnergyInlet'}}, 
					  'Outlet': {'inletOutlet': {'type': 'inletOutlet', 'inletValue': '$internalField', 'value': '$internalField'}}, 
					  'Solid': {'kqRWallFunction': {'type': 'kqRWallFunction', 'value': '$internalField'}}},
                '3': {'Inlet/outlet': {'inletOutlet': {'type': 'inletOutlet', 'inletValue': '$internalField', 'value': '$internalField'}}, 
					  'Solid': {'kqRWallFunction': {'type': 'kqRWallFunction', 'value': '$internalField'}}},
                '4': {'Patch': '', 
				   	  'Wall': '', 
					  'Symmetry': ''}}
...
flovi_epsilon_dict = {'0': {'Outlet': {'inletOutlet': {'type': 'inletOutlet', 'inletValue': '$internalField', 'value': '$internalField'}},
					  ...
					  '1': {'Inlet': {'fixedValue': {'type': 'fixedValue', 'value': '$internalField'}}, 
							'Outlet': {'inletOutlet': {'type': 'inletOutlet', 'inletValue': '$internalField', 'value': '$internalField'}}, 
							'Solid': {'epsilonWallFunction': {'type': 'epsilonWallFunction', 'value': '$internalField'}}},
					  '2': {'Inlet': {'turbulentMixingLengthDissipationRateInlet': {'type': 'turbulentMixingLengthDissipationRateInlet', 'mixingLength': '0.00168', 'value': '$internalField'}}, 
							'Outlet': {'inletOutlet': {'type': 'inletOutlet', 'inletValue': '$internalField', 'value': '$internalField'}}, 
							'Solid': {'epsilonWallFunction': {'type': 'epsilonWallFunction', 'value': '$internalField'}}},
					  '3': {'Inlet/outlet': {'inletOutlet': {'type': 'inletOutlet', 'inletValue': '$internalField', 'value': '$internalField'}}, 
							'Solid': {'epsilonWallFunction': {'type': 'epsilonWallFunction', 'value': '$internalField'}}},
...
flovi_nut_dict = {'0': {'Outlet': {'calculated': {'type': 'calculated', 'value': '$internalField'}},
                      ...
                      'Sky': {'symmetry': {'type': 'symmetry'}}},
                 '1': {'Inlet': {'calculated': {'type': 'calculated', 'value': '$internalField'}}, 
					  'Outlet': {'calculated': {'type': 'calculated', 'value': '$internalField'}}, 
					  'Solid': {'nutkWallFunction': {'type': 'nutkWallFunction', 'value': '$internalField'}}},
                 '2': {'Inlet': {'calculated': {'type': 'calculated', 'value': '$internalField'}}, 
					  'Outlet': {'calculated': {'type': 'calculated', 'value': '$internalField'}}, 
					  'Solid': {'nutkWallFunction': {'type': 'nutkWallFunction', 'value': '$internalField'}}},
                 '3': {'Inlet/outlet': {'calculated': {'type': 'calculated', 'value': '$internalField'}}, 
					  'Solid': {'nutkWallFunction': {'type': 'nutkWallFunction', 'value': '$internalField'}}},
                 '4': {'Patch': '', 
				   	  'Wall': '', 
					  'Symmetry': ''}}
...
flovi_prgh_dict = {'0': {},
                   '1': {},
                   '2': {'Inlet': {'fixedFluxPressure': {'type': 'fixedFluxPressure'}}, 
                	     'Outlet': {'prghPressure': {'type': 'prghPressure'}}, 
                	     'Solid': {'fixedFluxPressure': {'type': 'fixedFluxPressure'}}},
                   '3': {'Inlet/outlet': {'totalPressure': {'type': 'totalPressure'}}, 
						 'Solid': {'fixedFluxPressure': {'type': 'fixedFluxPressure'}}},
                   '4': {'Patch': '', 
				   		 'Wall': '', 
						 'Symmetry': ''}}
...
flovi_t_dict = {'0': {},
                '1': {},
                '2': {'Inlet': {'fixedValue': {'type': 'fixedValue'}}, 
                      'Outlet': {'zeroGradient': {'type': 'zeroGradient'}},  
                      'Solid': {'zeroGradient': {'type': 'zeroGradient'}, 'fixedValue': {'type': 'fixedValue'}}},
                '3': {'Inlet/outlet': {'zeroGradient': {'type': 'zeroGradient'}}, 
...
flovi_a_dict = {'0': {},
                ...
                '2': {'Inlet': {'calculated': {'type': 'calculated'}}, 
                      'Outlet': {'calculated': {'type': 'calculated'}},  
                      'Solid': {'compressible::alphatJayatillekeWallFunction': {'type': 'compressible::alphatJayatillekeWallFunction'}}},
                '3': {'Inlet/outlet': 'inletOutlet', 
                      'Solid': ('zeroGradient', 'fixedValue')},
                '4': {'Patch': '', 
				   	  'Wall': '', 
					  'Symmetry': ''}}