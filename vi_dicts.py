...
rvuparams = {"-ab": (2, 3, 4), "-ad": (256, 1024, 4096), "-as": (128, 512, 2048), "-aa": (0, 0, 0), "-ar": (8, 32, 128),
             "-dj": (0, 0, 1), "-ds": (0.5, 0.15, 0.15), "-dr": (1, 3, 5),
...
rtraceparams = {"-ab": (2, 4, 8), "-ad": (256, 1024, 4096), "-as": (128, 512, 2048), "-aa": (0, 0, 0), "-ar": (8, 32, 128),
                "-dj": (0, 0, 0), "-ds": (0, 0.5, 0.15), "-dr": (1, 3, 5), "-ss": (0, 2, 5), "-st": (1, 0.75, 0.1),
                "-lw": (0.0001, 0.00001, 0.000002), "-lr": (4, 8, 16)}

rtracecbdmparams = {"-ab": (4, 8), "-ad": (4096, 16384), "-as": (512, 1024), "-aa": (0, 0), "-ar": (32, 128),
                    "-dj": (0, 0), "-ds": (0.5, 0.15), "-dr": (2, 3), "-ss": (2, 5), "-st": (0.75, 0.1),
                    "-ss": (2, 5), "-st": (0.75, 0.1),
                    "-lw": (1e-4, 1e-7), "-lr": (3, 5)}

rcontribpmparams = {"-ab": (1, 1), "-ad": (4096, 16384), "-as": (512, 1024), "-aa": (0, 0), "-ar": (32, 128),
                    "-dj": (0, 0), "-ds": (0.5, 0.15), "-dr": (2, 3), "-ss": (2, 5), "-st": (0.75, 0.1),
                    "-ss": (2, 5), "-st": (0.75, 0.1),
                    "-lw": (1e-4, 1e-7), "-lr": (3, 5)}
...
zresdict = {'Zone Air Temperature [C] !Hourly': "Temperature (degC)",
            ...
            'Enclosure Windows Total Transmitted Solar Radiation Rate [W] !Hourly': 'Solar gain (W)',
            ...
            'AFN Node Wind Pressure [Pa] !Hourly': 'Wind Pressure (Pa)',
...
flovi_b_dict = {'Inlet': 'patch', 'Outlet': 'patch', 'Inlet/outlet': 'patch', 'Sky': 'symmetry',
...
flovi_k_dict = {'0': {'Outlet': ('inletOutlet', ),
                      ...
                      'Inlet': ('fixedValue', 'atmBoundaryLayerInletK'),
                      'Sky': ('symmetry', )},
                '1': {'Inlet': ('fixedValue', ),
                        'Outlet': ('inletOutlet', ),
                        'Solid': ('kqRWallFunction', 'zeroGradient')},
...
flovi_epsilon_dict = {'0': {'Outlet': ('inletOutlet', ),
                              ...
                              'Inlet': ('fixedValue', 'atmBoundaryLayerInletEpsilon'),
                              'Sky': ('symmetry', )},
                        '1': {'Inlet': ('fixedValue', ),
                              'Outlet': ('inletOutlet', ),
                              'Solid': ('epsilonWallFunction', 'zeroGradient')},
...
flovi_nut_dict = {'0': {'Outlet': ('calculated', ),
                        'Solid': ('nutkWallFunction', 'nutkAtmRoughWallFunction'),
                      	'Inlet': ('calculated', ),
                      	'Sky': ('symmetry', )},
                 '1': {'Inlet': ('calculated', ),
					   'Outlet': ('calculated', ),
