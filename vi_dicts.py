...
flovi_k_dict = {'0': {'Outlet': ('inletOutlet', ),
                      'Solid': ('kqRWallFunction', ),
                      'Inlet': ('fixedValue', ),
                      'Sky': ('symmetry', )},
                '1': {'Inlet': ('fixedValue', ), 
					  'Outlet': ('inletOutlet', ), 
					  'Solid': ('kqRWallFunction', )},
                '2': {'Inlet': ('turbulentIntensityKineticEnergyInlet', ), 
					  'Outlet': ('inletOutlet', ), 
					  'Solid': ('kqRWallFunction', )},
                '3': {'Inlet': ('inletOutlet', ), 
					  'Outlet': ('inletOutlet', ),
...
flovi_epsilon_dict = {'0': {'Outlet': ('inletOutlet', ),
							'Solid': ('epsilonWallFunction', ),
							'Inlet': ('fixedValue', ),
							'Sky': ('symmetry', )},
					  '1': {'Inlet': ('fixedValue', ), 
							'Outlet': ('inletOutlet', ), 
							'Solid': ('epsilonWallFunction', )},
					  '2': {'Inlet': ('turbulentMixingLengthDissipationRateInlet', ), 
							'Outlet': ('inletOutlet', ), 
							'Solid': ('epsilonWallFunction', )},
					  '3': {'Inlet': ('inletOutlet', ), 
					        'Outlet': ('inletOutlet', ), 
