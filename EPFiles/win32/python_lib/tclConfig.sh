...
TCL_CFLAGS_DEBUG='-nologo -c -W3 -YX -FpD:\_w\1\b\externals\tcl-core-8.6.13.0\win\Release_AMD64_VC13\tcl_ThreadedDynamic\ -MDd'
TCL_CFLAGS_OPTIMIZE='-nologo -c -W3 -YX -FpD:\_w\1\b\externals\tcl-core-8.6.13.0\win\Release_AMD64_VC13\tcl_ThreadedDynamic\ -MD'
...
# installed.
TCL_PREFIX='D:\_w\1\a\amd64'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:\_w\1\a\amd64\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:\_w\1\a\amd64\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:\_w\1\a\amd64\include'
...
# compiled.
TCL_SRC_DIR='D:\_w\1\b\externals\tcl-core-8.6.13.0\win\..'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-LD:\_w\1\b\externals\tcl-core-8.6.13.0\win\Release_AMD64_VC13 tclstub86.lib'
...
TCL_BUILD_STUB_LIB_PATH='D:\_w\1\b\externals\tcl-core-8.6.13.0\win\Release_AMD64_VC13\tclstub86.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='D:\_w\1\a\amd64\lib\tclstub86.lib'
